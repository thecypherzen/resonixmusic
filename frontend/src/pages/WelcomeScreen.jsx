  ...
  return (
    <div className="flex flex-col mx-auto gap-6 relative w-screen h-screen">
      ...
      <div className='flex flex-col items-center my-auto'>
        ...
        <img src="/logo-grad.png" alt="resonix logo" className="w-[24rem] lg:w-[34rem] mx-auto mb-6" />
        <p className='text-center italic mb-8'>
          ...let the music resonates in your soul!
        </p>

        {/* next arrow */}
        <button to='/login' className='mx-auto bg-[#212121] rounded-full p-2 h-10 w-10 lg:h-14 lg:w-14 border-neutral-800 border'>
