...
const WelcomeScreen = () => {
  return (
    <div className="flex flex-col mx-auto gap-6 relative w-screen h-screen">
      ...
      <div className='w-[600px] h-[600px] bg-gradient-to-r from-purple-500 from-10% via-blue-700 to-sky-500 blur-[200px] rounded-full -z-20 absolute -mt-40 -ml-40 opacity-80 '></div>
