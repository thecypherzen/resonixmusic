...
const TopNav = () => {
  ...
  return (
    <div className="w-full flex flex-row bg-transparent items-center py-10 px-16 h-[4.375rem] mx-auto sticky top-0 z-50 bg-white-400 bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-20 !border-2 border-green-400">
      {/* Searchbar */}
