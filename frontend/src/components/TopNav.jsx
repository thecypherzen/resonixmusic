...
function TopNav() {
  ...
  return (
    <div className="flex flex-row w-full bg-transparent items-center py-10 px-5 md:px-10 lg:px-16 max-h-[3.5rem] mx-auto sticky top-0 z-500 bg-white-400 bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-20 gap-4">
