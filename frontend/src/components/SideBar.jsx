...
const SideBar = () => {
  ...
  return (
    <>
      <div className="p-7 bottom-0 flex flex-col gap-6 min-h-screen overflow-y-scroll bg-[#212124] bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-30">
        {/* Navbar */}
        ...
        {/* Navigation Links */}
        <div className="flex flex-col gap-6 mt-2 ml-2 py-8">
          <Link
            to="/"
